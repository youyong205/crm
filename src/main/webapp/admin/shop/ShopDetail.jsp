		...
		<table class="table table-striped table-bordered table-condensed">
			...
			<tr>
				...
				<td><input type="text" name="shop.name"
					class="{required:true,maxlength:128}" readonly value="<s:property value="shop.name"/>" /></td>
			</tr><tr>
				<td style="text-align: right;"><strong
					class="text-success">地址</strong></td>
				<td><input type="text" name="shop.address"
					class="{required:true,maxlength:128}" readonly value="<s:property value="shop.address"/>" /></td>
			</tr><tr>
				<td style="text-align: right;"><strong
					class="text-success">面积(平方米)</strong></td>
				<td><input type="text" name="shop.area"
					class="{required:true,number:true}" readonly value="<s:property value="shop.area"/>" /></td>
			</tr><tr>
				<td style="text-align: right;"><strong
					class="text-success">房租</strong></td>
				<td><input type="text" name="shop.rent"
					class="{required:true,number:true}" readonly value="<s:property value="shop.rent"/>" /></td>
			</tr>
			<tr>
				<td style="text-align: right;"><strong
					class="text-success">前厅员工总数</strong></td>
				<td><input type="text" name="shop.staff1"
					class="{required:true,number:true}" readonly value="<s:property value="shop.staff1"/>" /></td>
			</tr><tr>
				<td style="text-align: right;"><strong
					class="text-success">前厅员工薪资</strong></td>
				<td><input type="text" name="shop.salary1"
					class="{required:true,number:true}" readonly value="<s:property value="shop.salary1"/>" /></td>
			</tr><tr>
				<td style="text-align: right;"><strong
					class="text-success">后厅员工总数</strong></td>
				<td><input type="text" name="shop.staff2"
					class="{required:true,number:true}" readonly value="<s:property value="shop.staff2"/>" /></td>
			</tr><tr>
				<td style="text-align: right;"><strong
					class="text-success">后厅员工总数</strong></td>
				<td><input type="text" name="shop.salary2"
					class="{required:true,number:true}" readonly value="<s:property value="shop.salary2"/>" /></td>
			</tr><tr>
				<td style="text-align: right;"><strong
					class="text-success">上月销售总额</strong></td>
				<td><input type="text" name="shop.sales"
					class="{required:true,number:true}" readonly readonly value="<s:property value="shop.sales"/>" /></td>
			</tr><tr>
				<td style="text-align: right;"><strong
					class="text-success">上月采购总额</strong></td>
				<td><input type="text" name="shop.purchase"
					class="{required:true,number:true}" readonly value="<s:property value="shop.purchase"/>" /></td>
			</tr><tr style="display:none">
				<td style="text-align: right;"><strong
					class="text-success">上月毛利率</strong></td>
				<td><input type="text" name="shop.interest"
					class="{required:true,number:true}" readonly value="<s:property value="shop.interest"/>" /></td>
			</tr>
		</table>
	</table>
</a:body>
